        ...
        <div className=" w-[100%] flex flex-col gap-2 ">
          <div className="flex  gap-10 justify-between">
            <div className="h-[10vh] w-[50%] flex flex-col">
              ...
              <input onChange={(e)=>setEducationObj({...educationObj, schoolname: e.target.value})}
            ...
            <div className="h-[10vh] w-[50%]  flex flex-col">
              ...
              <input onChange={(e)=>setEducationObj({...educationObj, schoolLocation : e.target.value})}
                className="border-[1px] border-black outline-none h-[4vh] w-[100%]"
                type="text"
              ></input>
            </div>
          ...
          <div className="flex  gap-10 justify-between">
            <div className="h-[10vh] w-[50%] flex flex-col">
              ...
              <input onChange={(e)=>setEducationObj({...educationObj, startDate : e.target.value})}
                className="border-[1px] border-black outline-none h-[4vh] w-[100%]"
                type="text"
              ></input>
            </div>
            <div className="h-[10vh] w-[50%]  flex flex-col">
              ...
              <input onChange={(e)=>setEducationObj({...educationObj, endDate : e.target.value})}
                className="border-[1px] border-black outline-none h-[4vh] w-[100%]"
                type="text"
              ></input>
            </div>
          ...
          <div className="flex  gap-10 justify-between">
            <div className="h-[10vh] w-[50%] flex flex-col">
              ...
              <input onChange={(e)=>setEducationObj({...educationObj, degree : e.target.value})}
                className="border-[1px] border-black outline-none h-[4vh] w-[100%]"
                type="text"
              ></input>
            </div>
            <div className="h-[10vh] w-[50%] flex flex-col">
              ...
              <input onChange={(e)=>setEducationObj({...educationObj, field : e.target.value})}
                className="border-[1px] border-black outline-none h-[4vh] w-[100%]"
                type="text"
              ></input>
            </div>
